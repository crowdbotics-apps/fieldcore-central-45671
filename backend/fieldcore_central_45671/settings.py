"""
Django settings for fieldcore_central_45671 project.
...
ROOT_URLCONF = 'fieldcore_central_45671.urls'
...
WSGI_APPLICATION = 'fieldcore_central_45671.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fieldcore_central_45671 API",
    "DESCRIPTION": "API documentation for fieldcore_central_45671 App",
    "VERSION": "v1",
}
